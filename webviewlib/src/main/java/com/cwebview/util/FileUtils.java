...
public class FileUtils {
    ...
    */
	...
	public static long getUsableSpace(File path) {
    	if(path==null || path.getPath()==null || "".equals(path.getPath().trim())){
    		return 0;
    	}
	 ...
	 * @param targetF
	 */
	public static void del(String targetF){
		if(!StringUtil.isEmpty(targetF)){
			del(new File(targetF));
		}
	}
	 ...
	 * @param targetF
	 */
	public static void del(File targetF){
		if( targetF != null ){
